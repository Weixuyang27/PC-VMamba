...
class LCVMUNet(nn.Module):
    def __init__(self,
        ...
        self.lcvmunet = PCViM(input_channels=input_channels,num_classes=num_classes,depths=depths,
...
if __name__ == '__main__':
    ...
    model = LCVMUNet(load_ckpt_path="/hy-tmp/PCViM/configs/pre_trained_weights/local_vssm_small.ckpt",)
